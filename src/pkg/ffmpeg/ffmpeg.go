...
type FFMpeg interface {
	...
	VideoFromImages(ctx context.Context, sourceDir string, outputFile string, options ...VideoOption) error
	...
	Concat(ctx context.Context, sourceDir string, outputFile string) error
}
